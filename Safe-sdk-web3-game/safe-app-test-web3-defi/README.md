...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/OnxmnSkIec)
...
```sh
npx nx serve safe-app-test-web3-defi
```

To create a production bundle:

```sh
npx nx build safe-app-test-web3-defi
```

To see all available targets to run for a project, run:

```sh
npx nx show project safe-app-test-web3-defi
```
